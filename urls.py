...
urlpatterns = defaults.patterns(
    ...
    (r'^admin/templates/$', 'admin.list_templates'),
    (r'^admin/templates/new/$', 'admin.new_template'),
    (r'^admin/templates/edit/([\w\-]+)$', 'admin.edit_template'),
    (r'^admin/templates/delete/([\w\-]+)$', 'admin.delete_template'),
